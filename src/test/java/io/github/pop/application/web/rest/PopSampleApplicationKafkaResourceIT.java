...
public class PopSampleApplicationKafkaResourceIT {
    ...
    @BeforeEach
    public void setup() {
        PopSampleApplicationKafkaResource kafkaResource = new PopSampleApplicationKafkaResource(kafkaProducer);
    ...
    public void sendMessageToKafkaTopic() throws Exception {
        restMockMvc.perform(post("/api/pop-sample-application-kafka/publish?message=yolo"))
