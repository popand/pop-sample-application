...
import io.github.pop.application.repository.EmployeeRepository;
import io.github.pop.application.repository.search.EmployeeSearchRepository;
...
/**
 * REST controller for managing {@link io.github.pop.application.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    public ResponseEntity<List<Employee>> searchEmployees(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
