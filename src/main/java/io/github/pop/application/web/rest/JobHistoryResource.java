...
import io.github.pop.application.service.JobHistoryService;
...
/**
 * REST controller for managing {@link io.github.pop.application.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    public ResponseEntity<List<JobHistory>> searchJobHistories(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
